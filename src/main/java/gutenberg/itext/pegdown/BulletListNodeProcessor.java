...
public class BulletListNodeProcessor extends Processor {
    ...
    public void process(int level, Node node, InvocationContext context) {
        ...
        Float spacingBefore = context.iTextContext().<Float>getNullable(BULLET_LIST_SPACING_BEFORE).or(5f);
        Float spacingAfter = context.iTextContext().<Float>getNullable(BULLET_LIST_SPACING_AFTER).or(5f);
